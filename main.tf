resource "aws_secretsmanager_secret" "sm" {
  ...
  name                           = try(each.value["tf_outputs"], false) == true ? "/${each.key}/${var.region}/${var.environment}/${each.value["cluster_name"]}/values.yaml" : (lookup(each.value, "name_prefix", null) == null ? each.key : null)
  name_prefix                    = try(each.value["tf_outputs"], false) == true ? null : (lookup(each.value, "name_prefix", null) != null ? lookup(each.value, "name_prefix") : null)
